...
{	
	public class Line
	{
		...
		{
			if ((Math.Abs(line1.getP1().X - line2.getP1().X) < 2 && 
                Math.Abs(line1.getP1().Y - line2.getP1().Y) < 2) && 
                (Math.Abs(line1.getP2().X - line2.getP2().X) < 2 && 
                Math.Abs(line1.getP2().Y - line2.getP2().Y) < 2))
				return true;
			else
				return false;
		}
		...
		public static bool isCross(Line line1, Line line2)
		{
			...
			{
				if (line1.getP1().Y > line2.getP1().Y && line1.getP1().Y < line2.getP2().Y && 
                    line2.getP1().X > line1.getP1().X && line2.getP1().X < line1.getP2().X)
					return true;
			}
			else if (line1.Vertical && line2.Horizontal)
			{
				if (line1.getP1().X > line2.getP1().X && line1.getP1().X < line2.getP2().X &&
                    line2.getP1().Y > line1.getP1().Y && line2.getP1().Y < line1.getP2().Y)
					return true;
			}
