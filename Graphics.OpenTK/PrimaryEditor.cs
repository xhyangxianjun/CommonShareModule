...
namespace OpenTKMapMaker
{
    public partial class PrimaryEditor : Form
    {
        ...
        private void glControlTop_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            top_mousepos = new Location(Vector3.TransformNormal(mpos.ToOVector(), top_proj.Inverted()));
            if (top_selected)
            {
        ...
        private void glControlSide_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            side_mousepos = new Location(Vector3.TransformNormal(mpos.ToOVector(), side_proj.Inverted()));
            if (side_selected)
            {
        ...
        private void glControlOSide_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            oside_mousepos = new Location(Vector3.TransformNormal(mpos.ToOVector(), oside_proj.Inverted()));
            if (oside_selected)
            {
